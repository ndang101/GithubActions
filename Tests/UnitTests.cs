...
{
    [TestMethod]
    public void Subtract_Valid_Dang()
    {
    ...
    [TestMethod]
    public void Subtract_Invalid_Dang()
    {
    ...
    [TestMethod]
    public void Subtract_Null_Dang()
    {
...
{
    [TestMethod]
    public void Multiply_Valid_Dang()
    {
    ...
    [TestMethod]
    public void Multiply_Invalid_Dang()
    {
    ...
    [TestMethod]
    public void Multiply_Null_Dang()
    {
...
{
    [TestMethod]
    public void Divide_Valid_Dang()
    {
        Assert.AreEqual(2, Program.Divide("6", "3"));
        Assert.AreEqual(1.5, Program.Divide("3", "2"), 0.0001); // Added tolerance
        Assert.AreEqual(-4, Program.Divide("8", "-2"));
    }

    [TestMethod]
    public void Divide_Invalid_Dang()
    {
...
public class Power
{
    ...
    [TestMethod]
    public void Power_Invalid_Dang()
    {
